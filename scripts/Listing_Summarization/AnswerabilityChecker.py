# AnswerabilityChecker.py

# This is purely scaffolding provided by IDX Exchange. For future work, 
# this feature would complete a real estate search function and 
# provide the user with the experience of 'error handling'
